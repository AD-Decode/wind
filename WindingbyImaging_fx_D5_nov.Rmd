...
sink(paste(outpath, "Winding_Probed5_by_fx_VOL.txt")) 
'fx: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ fx*Genotype*Sex, geno_combined_VOL)
summary(lm)
lm$coefficients
...
sink(paste(outpath, "Winding_Probed5_by_fx_FA.txt")) 
'fx: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ fx*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_fx_DEG.txt")) 
'fx: Probe d5 AWN DEG'
c
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_fx_CLUS.txt")) 
