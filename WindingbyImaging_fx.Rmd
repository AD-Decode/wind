...
# Day 5 Probe by fx Vol


``` {r fxVOLbbDay5Probe, echo = FALSE}
...
# Day 5 Probe By fx FA

``` {r fxFAybDay5Probe, echo = FALSE}
...
# Day 5 Probe By fx DEG

``` {r fxDEGybDay5Probe, echo = FALSE}
...
``` {r fxCLUSybDay5Probe, echo = FALSE}
...
``` {r fxWindingbyMRIGraphs, echo = FALSE}
