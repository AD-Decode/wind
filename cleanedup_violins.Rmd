...
contrast(Probe_d5.emm, simple = c("Genotype", "Sex"))
...
#pwpp(Probe_d5.emm, aes = my.aes) + #ggplot2::scale_color_manual(values = my.pal)
...
#xtable_emm <- xtable::xtable(Probe_d5.emm, type = "response")
#print.xtable(xtable_emm)
