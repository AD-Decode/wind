---
title: "Absolute Winding Number by CPu Probe Day d5 "
...
# Day d5 Probe by CPu Vol


``` {r CPuVOLbbDayd5Probe, echo=FALSE}

plotCPuVOL <- ggplot(geno_combined_VOL, aes(x = CPu, y = Probe_d5,
  ...
  #geom_text(x=3,y=30,label=lm_eqn(geno_combined_VOL, 'Probe_d5','CPu'),color='red',parse=T) 
...
plotCPuVOLSex <- ggplot(geno_combined_VOL, aes(CPu, Probe_d5, 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_omnibus_anova_VOL.txt")) 
'CPu: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ CPu*Genotype*Sex, geno_combined_VOL)
'omnibus test'
...
# Day d5 Probe By CPu FA

``` {r CPuFAybDayd5Probe}

plotCPuFA <- ggplot(geno_combined_FA, aes(x = CPu, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Sex)) +
...
plotCPuFASex <- ggplot(geno_combined_FA, aes(CPu, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_omnibus_anova_FA.txt")) 
'CPu: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ CPu*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
# Day d5 Probe By CPu DEG

``` {r CPuDEGybDayd5Probe}

plotCPuDEG <- ggplot(geno_combined_DEG, aes(x = CPu, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
        scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
        scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
        geom_point(aes(shape = Sex)) +
...
plotCPuDEGSex <- ggplot(geno_combined_DEG, aes(CPu, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_omnibus_anova_DEG.txt")) 
'CPu: Probe d5 AWN DEG'
lm <- lm(Probe_d5 ~ CPu*Genotype*Sex, geno_combined_DEG)
'omnibus test'
joint_tests(ref_grid(lm)) 
joint_tests(ref_grid(lm), by = "Sex", adjust = "sidak") 
...
# Day d5 Probe By CPu CLUS

``` {r CPuCLUSybDayd5Probe}




plotCPuCLUS <- ggplot(geno_combined_CLUS, aes(x = CPu, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Sex)) +
...
plotCPuCLUSSex <- ggplot(geno_combined_CLUS, aes(CPu, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_omnibus_anova_CLUS.txt")) 
'CPu: Probe d5 AWN CLUSTERING'
lm <- lm(Probe_d5 ~ CPu*Genotype*Sex, geno_combined_CLUS)
'omnibus test'
joint_tests(ref_grid(lm)) 
joint_tests(ref_grid(lm), by = "Sex", adjust = "sidak") 
...
ggsave(paste(outpath,'Probed5_Winding_by_CPu.pdf',sep=''), plot = last_plot(), device='pdf', scale=1, width=10, height=20, unit=c("in"), dpi=200)
