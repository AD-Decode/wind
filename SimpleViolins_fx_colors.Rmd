...
plot1VOL<-ggplot(data_VOL, aes(x=Sex, y=fx, fill = Genotype, alpha=Sex)) +
...
plot1FA<-ggplot(data_FA, aes(Sex, fx, fill = Genotype, alpha=Sex)) +
  geom_violin(inherit.aes=TRUE,position=dodge) +
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  facet_grid(. ~ Genotype)  +
...
plot1DEG<-ggplot(data_DEG, aes(Sex, fx, fill = Genotype, alpha=Sex)) +
  geom_violin(inherit.aes=TRUE,position=dodge) +
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  facet_grid(. ~ Genotype)  +
...
plot1CLUS<-ggplot(data_CLUS, aes(Sex, fx, fill = Genotype, alpha=Sex)) +
  geom_violin(inherit.aes=TRUE,position=dodge) +
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  facet_grid(. ~ Genotype)  +
