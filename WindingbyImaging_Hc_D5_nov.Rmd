...
sink(paste(outpath, "Winding_Probed5_by_Hc_VOL.txt")) 
'Hc: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ Hc*Genotype*Sex, geno_combined_VOL)
summary(lm)
lm$coefficients
...
sink(paste(outpath, "Winding_Probed5_by_Hc_FA.txt")) 
'Hc: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ Hc*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_Hc_DEG.txt")) 
'Hc: Probe d5 AWN DEG'
c
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_Hc_CLUS.txt")) 
