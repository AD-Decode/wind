...
plot1VOL<-ggplot(data_VOL, aes(Sex, CPu, fill = Sex)) +
...
plot1FA<-ggplot(data_FA, aes(Sex, CPu, fill = Sex)) +
  geom_violin(inherit.aes=TRUE,position=dodge, alpha=0.8) +
  facet_grid(. ~ Genotype)  +
  geom_boxplot(color="black", outlier.color="black", width=0.2, alpha=.8, position=dodge) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize=2, alpha=0.6, position=dodge)+
...
plot1DEG<-ggplot(data_DEG, aes(Sex, CPu, fill = Sex)) +
  geom_violin(inherit.aes=TRUE,position=dodge, alpha=0.8) +
  facet_grid(. ~ Genotype)  +
  geom_boxplot(color="black", outlier.color="black", width=0.2, alpha=.8, position=dodge) +
  geom_dotplot(binaxis='y', stackdir='center', dotsize=2, alpha=0.6, position=dodge)+
...
plot_stat_VOL<-ggline(geno_combined_VOL, x = "Genotype", y = "CPu",
          color = "Genotype", fill = "Genotype", error.plot='errorbar', add='mean_se', palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, ylab='CPu Volume',  font.label = list(size = 20, face = "plain"))+ 
  #stat_compare_means(comparisons = my_comparisons)
  stat_compare_means(comparisons = my_comparisons, method="t.test")+
  stat_compare_means(label.y = 0.1)

plot_stat_FA<-ggline(geno_combined_FA, x = "Genotype", y = "CPu",
          color = "Genotype", fill = "Genotype", error.plot='errorbar', add='mean_se', palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, ylab='CPu FA')+ 
 # stat_compare_means(comparisons = my_comparisons)
stat_compare_means(comparisons = my_comparisons, method="t.test")+
  stat_compare_means(label.y = 0.1)

plot_stat_DEG<-ggline(geno_combined_DEG, x = "Genotype", y = "CPu",
          color = "Genotype", fill = "Genotype", error.plot='errorbar', add='mean_se', palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, ylab='CPu DEG')+ 
 # stat_compare_means(comparisons = my_comparisons)
stat_compare_means(comparisons = my_comparisons, method="t.test")+
  stat_compare_means(label.y = 0.1)

plot_stat_CLUS<-ggline(geno_combined_CLUS, x = "Genotype", y = "CPu",
          color = "Genotype", fill = "Genotype", error.plot='errorbar', add='mean_se', palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, ylab='CPu CLUS')+ 
  #stat_compare_means(comparisons = my_comparisons)
  stat_compare_means(comparisons = my_comparisons, method="t.test")+
  stat_compare_means(label.y = 0.1)
...
ggsave(paste(outpath,'CPu_4metrics_stat_compare2.pdf',sep=''), plot = last_plot(), device='pdf', scale=1, width=16, height=4, unit=c("in"), dpi=200)
...
#my_comparisons <- list( c("APOE22", "APOE33"), c("APOE22", "APOE44"), c("APOE33", "APOE44") )
pCPu_Volume<-ggline(geno_combined_VOL, x = "Genotype", y = "CPu",
          color = "Genotype", fill = "Genotype", error.plot='errorbar', add='mean_se', palette = c('blueviolet','chartreuse1','red'), size=1, 
...
summary(glht(lm_CPu_VOL, emm(pairwise ~ Genotype, contr="sidak")))
...
#post hoc tests
#post hoc tests
summary(glht(lm_CPu_FA, emm(pairwise ~ Genotype, contr="sidak")))
...
summary(glht(lm_CPu_DEG, emm(pairwise ~ Genotype )))
...
summary(glht(lm_CPu_CLUS, emm(pairwise ~ Genotype )))
