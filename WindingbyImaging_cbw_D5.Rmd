...
sink(paste(outpath, "Winding_Probed5_by_cbw_omnibus_anova_VOL.txt")) 
...
sink(paste(outpath, "Winding_Probed5_by_cbw_omnibus_anova_FA.txt")) 
'cbw: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ cbw*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_cbw_omnibus_anova_DEG.txt")) 
...
sink(paste(outpath, "Winding_Probed5_by_cbw_omnibus_anova_CLUS.txt")) 
