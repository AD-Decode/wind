---
title: "Absolute Winding Number by ic Probe Day d5 "
...
# Day d5 Probe by ic Vol


``` {r icVOLbbDayd5Probe, echo=FALSE}

ploticVOL <- ggplot(geno_combined_VOL, aes(x = ic, y = Probe_d5,
  ...
  #geom_text(x=3,y=30,label=lm_eqn(geno_combined_VOL, 'Probe_d5','ic'),color='red',parse=T) 
...
ploticVOLSex <- ggplot(geno_combined_VOL, aes(ic, Probe_d5, 
...
sink(paste(outpath, "Winding_Probed5_by_ic_omnibus_anova_VOL.txt")) 
'ic: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_VOL)
'omnibus test'
...
'slopes'
emtrends(lm, pairwise ~ Genotype, var = "ic")
emtrends(lm, pairwise ~ Genotype|Sex, var = "ic")
...
# Day d5 Probe By ic FA

``` {r icFAybDayd5Probe}

ploticFA <- ggplot(geno_combined_FA, aes(x = ic, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Sex)) +
...
ploticFASex <- ggplot(geno_combined_FA, aes(ic, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_ic_omnibus_anova_FA.txt")) 
'ic: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
# Day d5 Probe By ic DEG

``` {r icDEGybDayd5Probe}

ploticDEG <- ggplot(geno_combined_DEG, aes(x = ic, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
        scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
        scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
        geom_point(aes(shape = Sex)) +
...
ploticDEGSex <- ggplot(geno_combined_DEG, aes(ic, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_ic_omnibus_anova_DEG.txt")) 
'ic: Probe d5 AWN DEG'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_DEG)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
# Day d5 Probe By ic CLUS

``` {r icCLUSybDayd5Probe}




ploticCLUS <- ggplot(geno_combined_CLUS, aes(x = ic, y = Probe_d5,
                          color = Genotype,  fill = Genotype)) + 
  scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Sex)) +
...
ploticCLUSSex <- ggplot(geno_combined_CLUS, aes(ic, Probe_d5, 
                                   color = Genotype, fill = Genotype))+                   scale_color_manual(values=c('blueviolet', 'chartreuse1', 'red')) + 
  scale_fill_manual(values=c('blueviolet', 'chartreuse1', 'red'))+
  geom_point(aes(shape = Genotype)) + 
  facet_grid(. ~ Sex) + 
...
sink(paste(outpath, "Winding_Probed5_by_ic_omnibus_anova_CLUS.txt")) 
'ic: Probe d5 AWN CLUSTERING'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_CLUS)
'omnibus test'
joint_tests(ref_grid(lm)) 
joint_tests(ref_grid(lm), by = "Sex", adjust = "sidak") 
...
ggsave(paste(outpath,'Probed5_Winding_by_ic.pdf',sep=''), plot = last_plot(), device='pdf', scale=1, width=10, height=20, unit=c("in"), dpi=200)
