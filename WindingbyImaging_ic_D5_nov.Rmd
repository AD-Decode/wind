...
sink(paste(outpath, "Winding_Probed5_by_ic_VOL.txt")) 
'ic: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_VOL)
summary(lm)
lm$coefficients
...
sink(paste(outpath, "Winding_Probed5_by_ic_FA.txt")) 
'ic: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ ic*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_ic_DEG.txt")) 
'ic: Probe d5 AWN DEG'
c
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_ic_CLUS.txt")) 
