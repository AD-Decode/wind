...
sink(paste(outpath, "Winding_Probed5_by_CPu_VOL.txt")) 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_FA.txt")) 
'CPu: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ CPu*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_DEG.txt")) 
...
sink(paste(outpath, "Winding_Probed5_by_CPu_CLUS.txt")) 
