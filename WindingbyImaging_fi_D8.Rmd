...
sink(paste(outpath, "Winding_Probed8_by_fi_omnibus_anova_VOL.txt")) 
'fi: Probe d8 AWN VOL'
lm <- lm(Probe_d8 ~ fi*Genotype*Sex, geno_combined_VOL)
'omnibus test'
...
sink(paste(outpath, "Winding_Probed8_by_fi_omnibus_anova_FA.txt")) 
'fi: Probe d8 AWN FA'
lm <- lm(Probe_d8 ~ fi*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_fi_omnibus_anova_DEG.txt")) 
'fi: Probe d8 AWN DEG'
lm <- lm(Probe_d8 ~ fi*Genotype*Sex, geno_combined_DEG)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_fi_omnibus_anova_CLUS.txt")) 
