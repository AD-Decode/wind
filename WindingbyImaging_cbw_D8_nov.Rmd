...
sink(paste(outpath, "Winding_Probed8_by_cbw_VOL.txt")) 
...
sink(paste(outpath, "Winding_Probed8_by_cbw_FA.txt")) 
'cbw: Probe d8 AWN FA'
lm <- lm(Probe_d8 ~ cbw*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_cbw_DEG.txt")) 
...
sink(paste(outpath, "Winding_Probed8_by_cbw_CLUS.txt")) 
