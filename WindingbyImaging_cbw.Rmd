...
``` {r cbwVOLbbDay5Probe, echo = FALSE}
...
``` {r cbwDEGybDay5Probe, echo = FALSE}
...
``` {r cbwCLUSybDay5Probe, echo = FALSE}
...
plotcbwCLUSSex <- ggplot(geno_combined_CLUS, aes(cbw, Probe_d5, 
  ...
  panel_border() + 
  theme_bw() +
  labs(title = "Clustering Coeffcbwient",
       x = "cbw CLUS", y = "WN: Probe Day 5") +
  theme(legend.position="bottom")
  #stat_cor() +
...
``` {r cbwWindingbyMRIGraphs, echo = FALSE}
