...
sink(paste(outpath, "Winding_Probed8_by_CPu_omnibus_anova_VOL.txt")) 
...
'slopes'
emtrends(lm, pairwise ~ Genotype, var = "CPu")
emtrends(lm, pairwise ~ Genotype|Sex, var = "CPu")
...
sink(paste(outpath, "Winding_Probed8_by_CPu_omnibus_anova_FA.txt")) 
'CPu: Probe d8 AWN FA'
lm <- lm(Probe_d8 ~ CPu*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_CPu_omnibus_anova_DEG.txt")) 
...
sink(paste(outpath, "Winding_Probed8_by_CPu_omnibus_anova_CLUS.txt")) 
