...
outpath<-'Graphs_Stats_Expanded12mo/'
 
setwd("/Users/alex/AlexBadea_MyPapers/DavidDunson/behaviorAnalysis/CombinedAPOE/")
#masterFile<-'APOE_MWM_AB.csv' 

masterFile<-'APOE_MWM_AB_oct.csv'
outpath<-'Graphs_Stats_Expanded12mo_2022/'

masterFile<-'APOE_MWM_AB281221.csv'
outpath<-'Graphs_Stats_Expanded12mo_281221/'
#make Age==12 for this case


outpath<-'Graphs_Stats_Expanded18mo_281221/'
#make Age==18 for this case
...
df2<-subset(df, (APOE=='E22') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control')) #Keeps only Genotypes 2/2, 3/3, and 4/4
df2m<-subset(df, (APOE=='E22') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='M')) #Keeps only Genotypes 2/2, 3/3, and 4/4
df2f<-subset(df, (APOE=='E22') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='F')) #Keeps only Genotypes 2/2, 3/3, and 4/4
...
df3<-subset(df, (APOE=='E33') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control'))
df3m<-subset(df, (APOE=='E33') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='M')) #Keeps only Genotypes 2/2, 3/3, and 4/4
df3f<-subset(df, (APOE=='E33') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='F')) #Keeps only Genotypes 2/2, 3/3, and 4/4
...
df4<-subset(df, (APOE=='E44') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control'))
df4m<-subset(df, (APOE=='E44') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='M')) #Keeps only Genotypes 2/2, 3/3, and 4/4
df4f<-subset(df, (APOE=='E44') & (Age.months>=10) & (Age.months<=15)  & (Diet=='Control') & (Sex=='F')) #Keeps only Genotypes 2/2, 3/3, and 4/4
...
postHocTable<-matrix(nrow=4, ncol=6)

postHocTable[1,]=c('Genotype', 'No Animals', 'Males' , 'Female', 'Mean Age (months)', 'SD Age (months)')
postHocTable[2,]=c('APOE22', length(unique(df2$Animal)), length(unique(df2m$Animal)), length(unique(df2f$Animal)), mean(df2$Age.months, na.rm = TRUE),sd(as.numeric(df2$Age.months), na.rm = TRUE) )
postHocTable[3,]=c('APOE33', length(unique(df3$Animal)), length(unique(df3m$Animal)), length(unique(df3f$Animal)), mean(df3$Age.months, na.rm = TRUE),sd(as.numeric(df3$Age.months), na.rm = TRUE) )
postHocTable[4,]=c('APOE33', length(unique(df4$Animal)), length(unique(df4m$Animal)), length(unique(df4f$Animal)), mean(df4$Age.months, na.rm = TRUE),sd(as.numeric(df4$Age.months), na.rm = TRUE) )

myfile<-paste(outpath,'AnimalsSummary.csv',sep='')

write.table(postHocTable, file=myfile, sep=",", row.names=F, append=TRUE, col.names=T)
...
#dfAveraged<-aggregate(.~Animal+APOE+Sex+Test, dfFin, mean, na.action=na.pass)
dfAveraged<-aggregate(.~Animal+APOE+Sex+Test+Treatment+Code+Stage, dfFin, mean, na.action=na.pass)
#dfAveraged<-aggregate(dfFin,by=list(dfFin$Trial),FUN=mean,na.action=na.pass)
...
lm_DistanceNSW_d5 <- lm(DistNorm ~ Genotype*Sex, dfSWp1)
anova(lm_DistanceNSW_d5)
emmeans(lm_DistanceNSW_d5 , ~ Genotype*Sex, contr="tukey")
summary(glht(lm_DistanceNSW_d5, emm(pairwise ~ Genotype*Sex, adjust="sidak"))) #consider save to file
summary(glht(lm_DistanceNSW_d5, emm(pairwise ~ Genotype| Sex)))
summary(glht(lm_DistanceNSW_d5, emm(pairwise ~ Sex | Genotype)))
sink()
...
anova(lm_WindingD5)
emmeans(lm_WindingD5 , ~ Genotype*Sex, contr="tukey")
#33333
summary(glht(lm_WindingD5, emm(pairwise ~ Genotype*Sex, adjust="sidak"))) #consider save to file
summary(glht(lm_WindingD5, emm(pairwise ~ Genotype| Sex)))
summary(glht(lm_WindingD5, emm(pairwise ~ Sex | Genotype)))
#3333
sink()



lm_DistanceNSW_d8 <- lm(DistNorm ~ Genotype*Sex, dfSWp2)
sink(paste(outpath, "NormSWDist_D8_Tukey.txt"))
anova(lm_DistanceNSW_d8)
emmeans(lm_DistanceNSW_d8 , ~ Genotype*Sex, contr="tukey")
#33333
summary(glht(lm_DistanceNSW_d8, emm(pairwise ~ Genotype*Sex, adjust="sidak"))) #consider save to file
summary(glht(lm_DistanceNSW_d8, emm(pairwise ~ Genotype| Sex)))
summary(glht(lm_DistanceNSW_d8, emm(pairwise ~ Sex | Genotype)))
#3333
sink()


sink(paste(outpath, "Winding_D8_Tukeymodels.txt"))
lm_WindingD8 <- lm(Winding ~ Genotype*Sex, dfSWp2)
anova(lm_WindingD8)
emmeans(lm_WindingD8 , ~ Genotype*Sex, contr="tukey")
#33333
summary(glht(lm_WindingD8, emm(pairwise ~ Genotype*Sex, adjust="sidak"))) #consider save to file
summary(glht(lm_WindingD8, emm(pairwise ~ Genotype| Sex)))
summary(glht(lm_WindingD8, emm(pairwise ~ Sex | Genotype)))
#3333
sink()


dfQuad<-rbind(dfSW, dfSE, dfNW, dfNE)
dfQuad2<-subset(dfQuad, (Genotype=='E22')) #Info on all quadrants for genotype E22
dfQuad3<-subset(dfQuad, (Genotype=='E33')) #Info on all quadrants for genotype E33
dfQuad4<-subset(dfQuad, (Genotype=='E44')) #Info on all quadrants for genotype E44
...
postHocTable[3,]=c('E33-E22', tukey.test$APOE[1,1], tukey.test$APOE[1,2], tukey.test$APOE[1,3], tukey.test$APOE[1,4])
postHocTable[4,]=c('E44-E22', tukey.test$APOE[2,1], tukey.test$APOE[2,2], tukey.test$APOE[2,3], tukey.test$APOE[2,4])
postHocTable[5,]=c('E44-E33', tukey.test$APOE[3,1], tukey.test$APOE[3,2], tukey.test$APOE[3,3], tukey.test$APOE[3,4])
...
postHocTableF[3,]=c('E33-E22', tukey.test$APOE[1,1], tukey.test$APOE[1,2], tukey.test$APOE[1,3], tukey.test$APOE[1,4])
postHocTableF[4,]=c('E44-E22', tukey.test$APOE[2,1], tukey.test$APOE[2,2], tukey.test$APOE[2,3], tukey.test$APOE[2,4])
postHocTableF[5,]=c('E44-E33', tukey.test$APOE[3,1], tukey.test$APOE[3,2], tukey.test$APOE[3,3], tukey.test$APOE[3,4])

postHocTableM<-matrix(nrow=5, ncol=5)
postHocTableM[1,]=c('', '', '', '', '')
postHocTableM[2,]=c('Male TukeyHSD', 'mean diff', 'CIlwr', 'CIhi', 'p-value')
postHocTableM[3,]=c('E33-E22', tukey.test$APOE[1,1], tukey.test$APOE[1,2], tukey.test$APOE[1,3], tukey.test$APOE[1,4])
postHocTableM[4,]=c('E44-E22', tukey.test$APOE[2,1], tukey.test$APOE[2,2], tukey.test$APOE[2,3], tukey.test$APOE[2,4])
postHocTableM[5,]=c('E44-E33', tukey.test$APOE[3,1], tukey.test$APOE[3,2], tukey.test$APOE[3,3], tukey.test$APOE[3,4])
...
mydata.lm <- lm(Distance ~ APOE+Sex+Stage, data = dfAveraged)
anova(mydata.lm)
...
#33333
sink(paste(outpath, "NormSWDistAPOEDay4models.txt"))
mydata.lm <- lm(NormSWDist ~ APOE+Sex, data = dfAveraged)
anova(mydata.lm)
...
postHocTableF[1,]=c('', '', '', '', '')
postHocTableF[2,]=c('Female TukeyHSD', 'mean diff', 'CIlwr', 'CIhi', 'p-value')
postHocTableF[3,]=c('E33-E22', tukeyF.test$APOE[1,1], tukeyF.test$APOE[1,2], tukeyF.test$APOE[1,3], tukeyF.test$APOE[1,4])
postHocTableF[4,]=c('E44-E22', tukeyF.test$APOE[2,1], tukeyF.test$APOE[2,2], tukeyF.test$APOE[2,3], tukeyF.test$APOE[2,4])
postHocTableF[5,]=c('E44-E33', tukeyF.test$APOE[3,1], tukeyF.test$APOE[3,2], tukeyF.test$APOE[3,3], tukeyF.test$APOE[3,4])

postHocTableM<-matrix(nrow=5, ncol=5)
postHocTableM[1,]=c('', '', '', '', '')
postHocTableM[2,]=c('Male TukeyHSD', 'mean diff', 'CIlwr', 'CIhi', 'p-value')
postHocTableM[3,]=c('E33-E22', tukeyM.test$APOE[1,1], tukeyM.test$APOE[1,2], tukeyM.test$APOE[1,3], tukeyM.test$APOE[1,4])
postHocTableM[4,]=c('E44-E22', tukeyM.test$APOE[2,1], tukeyM.test$APOE[2,2], tukeyM.test$APOE[2,3], tukeyM.test$APOE[2,4])
postHocTableM[5,]=c('E44-E33', tukeyM.test$APOE[3,1], tukeyM.test$APOE[3,2], tukeyM.test$APOE[3,3], tukeyM.test$APOE[3,4])
...
#33333
# sink(paste(outpath, "WN_APOEDay5_models.txt"))
# mydata.lm <- lm(Winding ~ APOE+Sex|Stage, data = temp)
# anova(mydata.lm)
# summary(glht(mydata.lm, emm(pairwise ~ APOE|Sex, adjust="sidak"))) #consider save to file
# summary(glht(mydata.lm, emm(pairwise ~ Sex| APOE)))
# sink()
...
barCenters<-barplot(height=tabbedMeans,
                    ...
                    beside=TRUE, las=1,
                    cex.names=0.75,
                    main="Distance per Quadrant E22",
                    ylab="Distance (m)",
...
dfQuad2p1<-subset(dfQuadp1, Genotype=='E22')
dfQuad2p2<-subset(dfQuadp2, Genotype=='E22')
...
barCenters<-barplot(height=tabbedMeans,
                    ...
                    beside=TRUE, las=1,
                    cex.names=0.75,
                    main="Distance per Quadrant E33",
                    ylab="Distance (m)",
                    border="black", axes=TRUE,
                    legend.text=TRUE,
                    args.legend=list(title="Quadrant",
...
dfQuad3p1<-subset(dfQuadp1, Genotype=='E33')
dfQuad3p2<-subset(dfQuadp2, Genotype=='E33')
...
barCenters<-barplot(height=tabbedMeans,
                    ...
                    beside=TRUE, las=1,
                    cex.names=0.75,
                    main="Distance per Quadrant E44",
                    ylab="Distance (m)",
                    border="black", axes=TRUE,
                    legend.text=TRUE,
                    args.legend=list(title="Quadrant",
...
dfQuad4p1<-subset(dfQuadp1, Genotype=='E44')
dfQuad4p2<-subset(dfQuadp2, Genotype=='E44')
...
dfQuad2SW<-subset(dfSW, Genotype=='E22')
dfQuad3SW<-subset(dfSW, Genotype=='E33')
dfQuad4SW<-subset(dfSW, Genotype=='E44')
...
pdf(file=paste(outpath,'ProbeNormSWDistP1APOE.pdf',sep=''))
...
pdf(file=paste(outpath,'ProbeNormSWDistP2APOE.pdf',sep='') )
...
pdf(file=paste(outpath,'ProbeNormSWDistP1APOESex.pdf',sep='') )
...
pdf(file=paste(outpath,'ProbeNormSWDistP2APOESex.pdf',sep='') )
...
###start alex retests
'males and females'
sink(paste(outpath, "Retest_Winding_D5_Tukeymodels.txt"))
lm_Winding_d5 <- lm(Winding ~ APOE, dfp1)
anova(lm_Winding_d5)
summary(glht(lm_Winding_d5, emm(pairwise ~ APOE, adjust='tukey')))

'within females'
tempFemales <- subset(dfp1, Sex %in% "F")
dataF.lm <- lm(Winding ~ APOE, data = tempFemales)
summary(glht(dataF.lm, emm(pairwise ~ APOE)))
'within males'
tempMales <- subset(dfp1, Sex %in% "M")
dataM.lm <- lm(Winding ~ APOE, data = tempMales)
summary(glht(dataM.lm, emm(pairwise ~ APOE)))
...
dfp1$NormSWDist<-as.numeric(dfp1$NormSWDist)
...
dfp2$NormSWDist<-as.numeric(dfp2$NormSWDist)
