...
#define function for lm equation display
...
``` {r CPuVOLbbDay5Probe, echo = FALSE}
...
``` {r CPuDEGybDay5Probe, echo = FALSE}
...
``` {r CPuCLUSybDay5Probe, echo = FALSE}
...
``` {r CPuWindingbyMRIGraphs, echo = FALSE}
