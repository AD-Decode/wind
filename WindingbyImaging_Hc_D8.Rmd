...
sink(paste(outpath, "Winding_Probed8_by_Hc_omnibus_anova_VOL.txt")) 
'Hc: Probe d8 AWN VOL'
lm <- lm(Probe_d8 ~ Hc*Genotype*Sex, geno_combined_VOL)
'omnibus test'
...
'slopes'
emtrends(lm, pairwise ~ Genotype, var = "Hc")
emtrends(lm, pairwise ~ Genotype|Sex, var = "Hc")
...
sink(paste(outpath, "Winding_Probed8_by_Hc_omnibus_anova_FA.txt")) 
'Hc: Probe d8 AWN FA'
lm <- lm(Probe_d8 ~ Hc*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_Hc_omnibus_anova_DEG.txt")) 
'Hc: Probe d8 AWN DEG'
lm <- lm(Probe_d8 ~ Hc*Genotype*Sex, geno_combined_DEG)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed8_by_Hc_omnibus_anova_CLUS.txt")) 
