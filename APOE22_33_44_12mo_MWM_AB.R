...
#dfAveraged<-cbind(dfFin, residuals=lm1$residuals)
lm1<-lm(NormSWTime ~ Mean.speed, data=dfFin)
cor.test(lm1$residuals, dfFin$Mean.speed)
dfFin<-cbind(dfFin, residuals=lm1$residuals)
#dfFin<-cbind(dfFin, residuals=lm1$residuals)
...
ggline(dfFin, x='Stage', y='Duration', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red'), size=1,
       point.size=1.5, xlab='', ylab='Time to Platform (s)', legend='top')
...
temp <- subset(dfFin, Stage %in% "Day4")
...
tempFemales <- subset(dfFin, Sex %in% "F")
tempMales <- subset(dfFin, Sex %in% "M")
...
temp <- subset(dfFin, Stage %in% "Day2")
...
temp <- subset(dfFin, Stage %in% "Day5")
...
ggline(dfFin, x='Stage', y='Distance', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se', palette = c('blueviolet', 'chartreuse1', 'red'), size=1,
       point.size=1.5, xlab='', ylab='Distance to Platform (m)', legend='top')
...
data.lm <- lm(Distance ~ APOE, data = dfFin)
tukey.test <- TukeyHSD(data.aov)

#testMethod<-oneway.test(Distance ~ APOE, data = dfAveraged)
testMethod<-oneway.test(Distance ~ APOE, data = dfFin)
...
# # 
ggline(dfFin, x='Stage', y='NormSWDist', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se',palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, xlab='', ylab='Percent of Distance (SW)', legend='top')
...
data.lm <- lm(NormSWDist ~ APOE, data = dfFin)

data.aov <- aov(data.lm)
tukey.test <- TukeyHSD(data.aov)

#testMethod<-oneway.test(NormSWDist ~ APOE, data = dfAveraged)
testMethod<-oneway.test(NormSWDist ~ APOE, data = dfFin)
...
ggline(dfFin, x='Stage', y='NormSWTime', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se',palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, xlab='', ylab='Percent of Time (SW)', legend='top')
...
data.lm <- lm(NormSWTime ~ APOE, data = dfFin)
data.aov <- aov(data.lm)
tukey.test <- TukeyHSD(data.aov)

#testMethod<-oneway.test(NormSWTime ~ APOE, data = dfAveraged)
testMethod<-oneway.test(NormSWTime ~ APOE, data = dfFin)
...
ggline(dfFin, x='Stage', y='Mean.speed', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se',palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, xlab='', ylab='Mean Speed (m/s)', legend='top')
...
data.lm <- lm(Mean.speed ~ APOE, data = dfFin)
data.aov <- aov(data.lm)
tukey.test <- TukeyHSD(data.aov)

#testMethod<-oneway.test(Mean.speed ~ APOE, data = dfAveraged)
testMethod<-oneway.test(Mean.speed ~ APOE, data = dfFin)
...
temp <-subset(dfFin, Stage %in% "Day1")
...
ggline(dfFin, x='Stage', y='residuals', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se',palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, xlab='', ylab='Percent Quadrant Time (SW) - Residuals', legend='top')
...
data.lm <- lm(residuals ~ APOE, data = dfFin)
data.aov <- aov(data.lm)
tukey.test <- TukeyHSD(data.aov)

#testMethod<-oneway.test(residuals ~ APOE, data = dfAveraged)
testMethod<-oneway.test(residuals ~ APOE, data = dfFin)
...
ggline(dfFin, x='Stage', y='Winding', color='APOE', fill='APOE',
       error.plot='errorbar', add='mean_se',palette = c('blueviolet','chartreuse1','red'), size=1, 
       point.size = 1.5, xlab='', ylab='Winding Numbers', legend='top')
