...
sink(paste(outpath, "Winding_Probed5_by_fi_VOL.txt")) 
'fi: Probe d5 AWN VOL'
lm <- lm(Probe_d5 ~ fi*Genotype*Sex, geno_combined_VOL)
summary(lm)
lm$coefficients
...
sink(paste(outpath, "Winding_Probed5_by_fi_FA.txt")) 
'fi: Probe d5 AWN FA'
lm <- lm(Probe_d5 ~ fi*Genotype*Sex, geno_combined_FA)
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_fi_DEG.txt")) 
'fi: Probe d5 AWN DEG'
c
'omnibus test'
joint_tests(ref_grid(lm)) 
...
sink(paste(outpath, "Winding_Probed5_by_fi_CLUS.txt")) 
